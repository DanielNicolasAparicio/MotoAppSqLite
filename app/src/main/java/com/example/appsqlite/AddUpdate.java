...
public class AddUpdate extends AppCompatActivity {
    ...
    private CircleImageView civPhotos;
    private ActionBar actionBar;
    private EditText etBrand, etMotor, etColor, etModelo, etVelocidad, etPrice;

    private String brand, motor, color, model, velocidad, price;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        civPhotos = findViewById(R.id.civPhotos);
        ...
        civPhotos.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void insertData() {
        ...
        motor    = "" + etMotor.getText().toString().trim();
        color    = "" + etColor.getText().toString().trim();
        model           = "" + etModelo.getText().toString().trim();
        velocidad    = "" + etVelocidad.getText().toString().trim();
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == IMAGE_PICK_GALLERY_CODE) {
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    imageUri = resultUri;
                    civPhotos.setImageURI(resultUri);
